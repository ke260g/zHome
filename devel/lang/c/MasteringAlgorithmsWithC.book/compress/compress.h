...
/* node of Huffman trees */
typedef struct HuffNode_ {
    unsigned char symbol;
    int freq;
} HuffNode;

/* entries in Huffman code tables */
...
/* number of bits required for LZ77 token members */
#define LZ77_TYPE_BITS 1
#define LZ77_WINOFF_BITS 12
#define LZ77_BUFLEN_BITS 5
#define LZ77_NEXT_BITS 8

/* the size of the sliding window and the look-ahead buffer for             *
